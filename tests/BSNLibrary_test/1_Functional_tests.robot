...
Deprecated validate an excluded BSN with variable length
    [Documentation]    Steps:
    ...    - Exclude a BSN
    ...    - Validate the same BSN
    ...    This is repeated for every possible ``length``: 6, 7, 8 or 9. Default value 9 is covered by passing ``length=9`` to _Generate BSN_ as well as by leaving out the ``length`` argument.
    ...
    ...    Checks:
    ...    - The BSN is valid (i.e. it is not excluded from validation)
    ...    - There is a warning that validating with _Generate BSN_ is deprecated
    ...
    ...    The following statements are used by ``statuschecker`` to check the messages of _Clear Generated BSNs_
    ...
    ...    LOG 3.1.3.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 3.2.3.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 3.3.3.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 3.4.3.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 3.5.3.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    @{lengths}    Create List    ${None}    ${9}    ${8}    ${7}    ${6}
    FOR    ${length}    IN    @{lengths}
        ${bsn}    Run Keyword If    ${length}    Generate BSN    length=${length}
        ...    ELSE    Generate BSN
        Exclude BSNs    ${bsn}
        Run Keyword If    ${length}    Generate BSN    ${bsn}    length=${length}
        ...    ELSE    Generate BSN    ${bsn}
    END
...
Deprecated validate invalid BSNs with variable length
    [Documentation]    Validates an invalid BSN for every possible ``length``: 6, 7, 8 or 9. Default value 9 is covered by passing ``length=9`` to _Generate BSN_ as well as by leaving out the ``length`` argument.
    ...
    ...
    ...
    ...    Checks:
    ...    - Results in fail with correct message
    ...    - There is a warning that validating with _Generate BSN_ is deprecated
    ...
    ...    The following statements are used by ``statuschecker`` to check the messages of _Clear Generated BSNs_
    ...
    ...    LOG 6.1.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.2.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.3.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.4.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.5.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.6.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.7.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.8.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.9.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    ...
    ...    LOG 6.10.1.1.1 WARN Validation with 'Generate BSN' is deprecated. Use 'Validate BSN' instead.
    # Path: remainder is 10
    ${givens}    Create List    478280490    784035889    53876268    5845217    228456
    ${lengths}    Create List    ${None}    ${9}    ${8}    ${7}    ${6}
    # Path: last digit not equal to remainder
    Append To List    ${givens}    359457740    207232909    23533128    7894067    314616
    Append To List    ${lengths}    ${None}    ${9}    ${8}    ${7}    ${6}
    # Validate all given BSNs
    FOR    ${given}    ${length}    IN ZIP    ${givens}    ${lengths}
        Run Keyword If    ${length}    Run Keyword And Expect Error    The given number '${given}' is not valid.    Generate BSN    ${given}    length=${length}
        ...    ELSE    Run Keyword And Expect Error    The given number '${given}' is not valid.    Generate BSN    ${given}
    END
